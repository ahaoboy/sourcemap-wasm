...
export default class SourceMap {
    ...
    _indexedMappingsToInt32Array(
        ...
        for (let mapping of mappings) {
            ...
            // $FlowFixMe
            mappingBuffer[i++] = hasValidOriginal
     ...
     */
    getSourcesContentMap(): Record<string, string | null> {
    ...
    indexedMappingToStringMapping(
        mapping: IndexedMapping<number> | null | undefined,
    ): IndexedMapping<string> | null | undefined {
    ...
    findClosestMapping(
        ...
        let mapping = this.sourceMapInstance.findClosestMapping(
            line - 1,
            column,
        );
