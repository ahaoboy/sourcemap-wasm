...
* @returns {any}
*/
  addVLQMap(vlq_mappings: string, sources: any, sources_content: any, names: any, line_offset: number, column_offset: number): any;
/**
* @returns {any}
*/
  toVLQ(): any;
...
* @returns {any}
*/
  offsetColumns(generated_line: number, generated_column: number, generated_column_offset: number): any;
}
...
export interface InitOutput {
  ...
  readonly sourcemap_addVLQMap: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => void;
  ...
  readonly sourcemap_getSourceIndex: (a: number, b: number, c: number, d: number) => void;
  readonly sourcemap_addIndexedMappings: (a: number, b: number, c: number) => void;
  readonly sourcemap_toBuffer: (a: number, b: number) => void;
  readonly sourcemap_addSourceMap: (a: number, b: number, c: number, d: number) => void;
  readonly sourcemap_setSourceContentBySource: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
  readonly sourcemap_getSourceContentBySource: (a: number, b: number, c: number, d: number) => void;
  readonly sourcemap_addEmptyMap: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
  readonly sourcemap_extends: (a: number, b: number, c: number) => void;
  readonly sourcemap_findClosestMapping: (a: number, b: number, c: number) => number;
  readonly sourcemap_offsetLines: (a: number, b: number, c: number, d: number) => void;
  readonly sourcemap_offsetColumns: (a: number, b: number, c: number, d: number, e: number) => void;
