fork https://github.com/parcel-bundler/source-map
```ts
import { init, SourceMap } from "sourcemap-wasm";

await init();
// or await init('https://unpkg.com/sourcemap-wasm@0.1.3/parcel_sourcemap_wasm/pkg/parcel_sourcemap_wasm_bg.wasm')
